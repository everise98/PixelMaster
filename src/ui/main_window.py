...
class MainWindow(QMainWindow):
    ...
    def _build_settings_panel(self) -> QFrame:
        ...
        method_hint.setStyleSheet(
            "font-size: 10px; color: #6b8a72; background: transparent; line-height: 1.4;"
        )
    ...
    def _build_content_panel(self) -> QWidget:
        ...
        self._empty_label.setStyleSheet(
            "font-size: 12px; color: #6b8a72; background: transparent; padding: 20px;"
        )
        ...
        self._count_label.setStyleSheet(
            "font-size: 12px; color: #6b8a72; background: transparent;"
        )
    ...
    def _build_footer(self) -> QWidget:
        ...
        bar.setStyleSheet("background-color: #f8fafb; border-top: 1px solid #93F1A5;")
        ...
        self._status_dot.setStyleSheet(
            "font-size: 10px; color: #2db558; background: transparent;"
        )
        self._status_text = QLabel("Ready")
        self._status_text.setStyleSheet(
            "font-size: 11px; color: #6b8a72; background: transparent;"
        )
        ...
        author_label.setStyleSheet(
            "font-size: 10px; color: #93a09a; background: transparent; letter-spacing: 0.5px;"
        )
